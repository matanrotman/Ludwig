...
3. **Review the drafted upstream toolbar PR** (`scratchpad/toolbar-pr-DRAFT.md`) and decide whether to send it. Prepared 2026-07-15 r2, nothing pushed. Accepting it removes one file from every future merge.
...
# Then verify by CONTENTS (not timestamp — see hazard 2 above):
KB=build/macos/Build/Products/Debug/AppFlowy.app/Contents/Frameworks/App.framework/Resources/flutter_assets/kernel_blob.bin
